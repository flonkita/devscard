...
const favoritesSectionData = {
  ...
  medias: {
    ...
    data: [
      ...
      {
        image: import('@/assets/favorites/media/logo-aurelearn.png'),
        title: 'Aurelearn',
        type: 'Site web',
      ...
      {
        image: import('@/assets/favorites/media/james-quick.jpeg'),
        title: 'James Q Quick',
        type: 'Chaîne YouTube',
        url: 'https://www.youtube.com/@JamesQQuick',
      },
      {
        image: import('@/assets/favorites/media/media-astro.jpeg'),
        title: 'Astro',
        type: 'Site Officiel',
